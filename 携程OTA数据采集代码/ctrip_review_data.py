...
def normalize_capture_overview_rows(capture: dict[str, Any], captured_at: datetime) -> list[list[Any]]:
    ...
    return [
        [
            ...
            parse_number(overview.get("styleScore")),
            parse_number(overview.get("safetyScore")),
...
def normalize_rating_overview_rows(
    ...
    return [
        [
            ...
            score_from_sub_scores(info, "ratingStyle", "ratingStyle"),
            score_from_sub_scores(info, "ratingSafe", "ratingSafe"),
...
def save_outputs(overview_rows: list[list[Any]], ranking_rows: list[list[Any]], sync_db: bool = False) -> tuple[Path, Path]:
    ...
    overview = write_single_sheet(
        ...
        overview_headers,
        overview_rows,
        widths=[20, 12, 14, 14, 16, 16, 16, 16, 16, 16, 18, 18, 16, 16, 16],
        datetime_columns={1},
    )
