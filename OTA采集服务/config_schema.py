...
ADVANCED_TEXT_GROUPS = [
    (
        ...
        [
            ...
            ("reply_scheduler.max_tasks_per_run", "单次最多评论回复"),
            ("promotion_scheduler.max_tasks_per_run", "单次最多推广控制任务"),
...
CONFIG_SECTIONS = [
    {
        ...
        "fields": [
            ...
            ("reply_scheduler.max_tasks_per_run", "单次最多评论回复", False, True),
            ("promotion_scheduler.max_tasks_per_run", "单次最多推广控制任务", False, True),
...
NUMBER_FIELDS = {
    ...
    "promotion_scheduler.max_tasks_per_run",
